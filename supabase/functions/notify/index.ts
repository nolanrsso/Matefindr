...
// Bouton "Changer les notifications" attaché sous CHAQUE MP du bot — géré par
// l'Edge Function d'interactions (smooth-endpoint, custom_id "notif_panel_open").
// Il ouvre le panneau complet : un bouton par type (Like/Match/Message) à
// activer ✅ ou couper 🔕, + Tout activer / Tout couper.
const MUTE_COMPONENTS = [{
  type: 1,
  components: [{ type: 2, style: 2, label: "Changer les notifications", custom_id: "notif_panel_open", emoji: { name: "🔔" } }],
}];
